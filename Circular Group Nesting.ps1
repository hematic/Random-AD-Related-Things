Function CheckNesting ($Group, $Parents)
{
    ...
    # If any group member matches any of the parents, we have detected an instance of circular nesting.
...
# Enumerate groups and populate Hash table. The key value will bethe Distinguished Name of the group. 
# The item value will be an array
